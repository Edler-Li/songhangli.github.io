...
As a result, precise control over excitation timing is lost, introducing uncertainty into the photon counting data and limiting the decay measurements.

To overcome these constraints, a new shutter control system is required. 
